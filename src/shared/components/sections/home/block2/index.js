      ...
      <div className="container-fluid">
        <div className={'row ' + style.wrapper1}>
          <div className="col-sm-4 col-xs-12">
            ...
            <img className={style.image1} src="/images/img_living.png" alt={images.image1.alt} />
          ...
          <div className="col-sm-4 col-xs-12">
            ...
            <img className={style.image1} src="/images/img_dining.png"alt={images.image2.alt} />
          ...
          <div className="col-sm-4 col-xs-12">
            ...
            <img className={style.image1} src="/images/img_bed.png" alt={images.image3.alt} />
